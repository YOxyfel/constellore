...
const entries = [
  ...
  [["Life", "Life"], [variant("Evolution", "🧬", "life", "Life transforms through evolution."), variant("Biodiversity", "🦋", "life", "Life branches into biodiversity."), variant("Family", "👨‍👩‍👧‍👦", "nature", "The lives connect as a family.")]],
  ...
  [["Star", "Star"], [variant("Constellation", "✨", "nature", "The stars connect as a constellation."), variant("Universe", "🌌", "nature", "The stars unfold into a universe."), variant("Binary Star", "🌟", "force", "The two stars become a binary star.")]],
  [["Rocket", "Rocket"], [variant("Spacecraft", "🛸", "structure", "The rockets combine into a spacecraft."), variant("Space Station", "🛰️", "structure", "The rockets assemble an orbital station."), variant("Comet", "☄️", "structure", "The rockets streak away like a comet.")]],
