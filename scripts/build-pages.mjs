...
gameHtml = gameHtml
  ...
  .replaceAll('href="/styles.css?v=1.9.0"', 'href="./styles.css?v=1.9.0"')
  .replaceAll('src="/app.js?v=1.6.0"', 'src="./app.js?v=1.6.0"');
...
const serviceWorker = `const CACHE = "constellore-pages-practice-v12";
const BASE = new URL("./", self.location.href);
const SHELL = ["./", "./styles.css?v=1.9.0", "./app.js?v=1.6.0", "./ctrl-hover.mjs?v=1.0.0", "./frictionless.mjs?v=1.0.0", "./local-beta.mjs", "./local-world.mjs", "./cosmic-twists.mjs", "./recipe-mastery.mjs?v=1.0.0", "./engagement-features.mjs?v=1.0.0", "./manifest.webmanifest", "./icon.svg"].map((path) => new URL(path, BASE).href);
