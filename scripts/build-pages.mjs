...
gameHtml = gameHtml
  ...
  .replaceAll('href="/styles.css?v=1.7.0"', 'href="./styles.css?v=1.7.0"')
  .replaceAll('src="/app.js?v=1.4.4"', 'src="./app.js?v=1.4.4"');
...
const serviceWorker = `const CACHE = "constellore-pages-practice-v8";
const BASE = new URL("./", self.location.href);
const SHELL = ["./", "./styles.css?v=1.7.0", "./app.js?v=1.4.4", "./local-beta.mjs", "./local-world.mjs", "./cosmic-twists.mjs", "./manifest.webmanifest", "./icon.svg"].map((path) => new URL(path, BASE).href);
