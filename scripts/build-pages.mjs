...
gameHtml = gameHtml
  ...
  .replaceAll('href="/styles.css?v=2.1.0"', 'href="./styles.css?v=2.1.0"')
  .replaceAll('src="/app.js?v=1.8.0"', 'src="./app.js?v=1.8.0"');
