...
gameHtml = gameHtml
  ...
  .replaceAll('href="/styles.css?v=1.8.0"', 'href="./styles.css?v=1.8.0"')
  .replaceAll('src="/app.js?v=1.5.5"', 'src="./app.js?v=1.5.5"');
...
const serviceWorker = `const CACHE = "constellore-pages-practice-v11";
const BASE = new URL("./", self.location.href);
const SHELL = ["./", "./styles.css?v=1.8.0", "./app.js?v=1.5.5", "./ctrl-hover.mjs?v=1.0.0", "./frictionless.mjs?v=1.0.0", "./local-beta.mjs", "./local-world.mjs", "./cosmic-twists.mjs", "./manifest.webmanifest", "./icon.svg"].map((path) => new URL(path, BASE).href);
