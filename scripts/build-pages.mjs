...
gameHtml = gameHtml
  ...
  .replaceAll('href="/styles.css?v=1.3.0"', 'href="./styles.css?v=1.3.0"')
...
const serviceWorker = `const CACHE = "constellore-pages-practice-v1";
const BASE = new URL("./", self.location.href);
const SHELL = ["./", "./styles.css?v=1.3.0", "./app.js?v=1.3.0", "./local-beta.mjs", "./local-world.mjs", "./manifest.webmanifest", "./icon.svg"].map((path) => new URL(path, BASE).href);
